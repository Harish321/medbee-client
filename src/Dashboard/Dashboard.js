...
import { deleteRecord, downloadRecord, getIncidentReportData, navigateToEditIncidentScreen } from "./DashboardActions";
...
export default function Dashboard(props){
    ...
    const handleIncidentActionCellClick = (params, event, details) => {
        switch(event.target.innerText){
            ...
            case DELETE_TEXT: deleteRecord(params, event); break;
            case DOWNLOAD_TEXT: downloadRecord(params, event); break;
        }
    }
